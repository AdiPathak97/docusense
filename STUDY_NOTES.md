...
6. [AI Engineering Concepts](#6-ai-engineering-concepts)
   - [6.1 RAG — Retrieval-Augmented Generation](#61-rag--retrieval-augmented-generation)
   - [6.2 Embeddings and Vector Search](#62-embeddings-and-vector-search)
   - [6.3 Chunking Strategy](#63-chunking-strategy)
   - [6.4 LangGraph — Agent Graph vs. Chain](#64-langgraph--agent-graph-vs-chain)
   - [6.5 Prompt Engineering as Code](#65-prompt-engineering-as-code)
   - [6.6 Provider Abstraction — Swappable LLMs](#66-provider-abstraction--swappable-llms)
   - [6.7 PDF Text Extraction — Why Library Choice Matters](#67-pdf-text-extraction--why-library-choice-matters)
   - [6.8 LangGraph Conditional Edges — Routing Between Nodes at Runtime](#68-langgraph-conditional-edges--routing-between-nodes-at-runtime)
   - [5.9 Agentic Loop Pattern — Query Rewriting with a Max-Retry Cap](#69-agentic-loop-pattern--query-rewriting-with-a-max-retry-cap)
